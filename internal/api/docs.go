...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/fleet/config/{instanceID}": {
            "get": {
                "description": "Returns the configuration layers that apply to this instance, merged from\nbroad to specific. The revision is a content hash served as an ETag, so a\nclient that sends If-None-Match gets 204 (no configuration authored) or 304\n(unchanged) instead of the payload. 204 is not an error condition.",
                "produces": [
                    "application/json"
                ],
                "tags": [
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Instance ID issued at registration",
                        "name": "instanceID",
                        "in": "path",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "Config revision the client already has",
                        "name": "If-None-Match",
                        "in": "header"
                    }
                ],
                "responses": {
                    ...
                    "204": {
                        "description": "No configuration applies to this service"
                    },
                    "304": {
                        "description": "Configuration unchanged"
                    },
                    "400": {
                        "description": "Bad Request",
                        "schema": {
                    ...
                    "404": {
                        "description": "Unknown or deregistered instance",
                        "schema": {
                            "$ref": "#/definitions/api.ErrorResponse"
                        }
                    },
        ...
        "/api/fleet/deregister/{instanceID}": {
            "delete": {
                "description": "Marks the instance deregistered and drops it from the discovery rosters.\nIdempotent; the identity can only be restored by registering again.",
                "produces": [
                    "application/json"
                ],
                "tags": [
        ...
        "/api/fleet/heartbeat/{instanceID}": {
            "post": {
                "description": "Marks the instance active. Unknown or deregistered instance ids are never\nrecreated — the service has to register again to obtain a new instance id.\nDeployments running NATS should use the heartbeat subject instead.",
                "produces": [
                    "application/json"
                ],
                "tags": [
        ...
        "/api/fleet/register/cluster/": {
            "post": {
                "description": "Registers an auxiliary cc-* service that belongs to one cluster and\nreturns the instance id it must present on every heartbeat and config pull.\nRe-registering the same cluster/hostname/serviceType issues a new instance id\nand invalidates the previous one.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.FleetRegisterRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Issued registration",
                        "schema": {
                            "$ref": "#/definitions/api.FleetRegisterResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.FleetInfraRegisterRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "api.FleetInfraRegisterRequest": {
            "type": "object",
            "properties": {
                "hostname": {
                    "description": "Host the service runs on",
                    "type": "string",
                    "example": "mgmt01"
                },
                "metaData": {
                    "description": "Free-form registration metadata",
                    "type": "object",
                ...
                "serviceType": {
                    "description": "Service type short code",
                    "type": "string",
                    "example": "ccb"
                }
            }
        },
        "api.FleetRegisterRequest": {
            "type": "object",
            "properties": {
                "cluster": {
        ...
        "api.FleetRegisterResponse": {
            "type": "object",
            "properties": {
                "configRevision": {
                    "description": "Config revision currently on record; 0 means no config was pulled yet",
                    "type": "integer",
                    "example": 0
                },
                "instanceId": {
                    "description": "Credential to present on every subsequent heartbeat and config pull",
                    "type": "string",
                    "example": "3f1c9a2b7d4e6f8a0b1c2d3e4f5a6b7c"
                }
            }
        },
        ...
        "schema.Job": {
            ...
            "properties": {
                ...
                "statistics": {
                    "$ref": "#/definitions/schema.JobStatisticsSet"
                },
                "subCluster": {
                    "type": "string",
                    "example": "main"
        ...
        "schema.MetricConfig": {
            ...
            "properties": {
                ...
                "tooltip": {
                    "description": "Tooltip text shown in frontend if defined",
                    "type": "string"
                },
                "unit": {
                    "description": "Unit of measurement",
